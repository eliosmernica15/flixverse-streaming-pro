...
export const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "frame-src 'self' blob: https://accounts.google.com https://*.firebaseapp.com https://www.google.com https://www.recaptcha.net https://vidlink.pro https://*.vidlink.pro https://player.videasy.net https://videasy.net https://*.videasy.net https://vidfast.pro https://*.vidfast.pro https://vidsrc.me https://*.vidsrc.me https://vidsrc.pm https://*.vidsrc.pm https://vidsrc.to https://*.vidsrc.to https://vidsrc.in https://*.vidsrc.in https://vidsrc.su https://*.vidsrc.su https://www.2embed.cc https://*.2embed.cc https://2embed.cc https://yapgrid.com https://*.yapgrid.com https://www.yapgrid.com https://www.youtube.com https://www.youtube-nocookie.com https://*.youtube.com https://*.youtube-nocookie.com",
