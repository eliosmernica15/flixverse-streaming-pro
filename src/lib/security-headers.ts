...
export const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "frame-src 'self' blob: https://accounts.google.com https://*.firebaseapp.com https://www.google.com https://www.recaptcha.net https://vidlink.pro https://*.vidlink.pro https://player.videasy.net https://videasy.net https://*.videasy.net https://vidfast.pro https://*.vidfast.pro https://vidsrc.sbs https://*.vidsrc.sbs https://vidsrc.me https://*.vidsrc.me https://vidsrc.net https://*.vidsrc.net https://www.2embed.cc https://*.2embed.cc https://2embed.cc https://multiembed.mov https://*.multiembed.mov https://embed.su https://*.embed.su https://yapgrid.com https://*.yapgrid.com https://www.yapgrid.com https://www.youtube.com https://www.youtube-nocookie.com https://*.youtube.com https://*.youtube-nocookie.com",
