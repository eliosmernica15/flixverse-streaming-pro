...
export const getEnv = (key: string): string => {
    ...
    const staticEnv: Record<string, string | undefined> = {
        ...
        'NEXT_PUBLIC_FIREBASE_RECAPTCHA_KEY': process.env.NEXT_PUBLIC_FIREBASE_RECAPTCHA_KEY,
        'NEXT_PUBLIC_FIREBASE_RECAPTCHA_V3_KEY': process.env.NEXT_PUBLIC_FIREBASE_RECAPTCHA_V3_KEY,
